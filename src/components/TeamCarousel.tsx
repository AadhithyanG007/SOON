...
export const TeamCarousel = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div
        ref={scrollRef}
        className="overflow-hidden px-4 sm:px-8 md:px-20 py-4 sm:py-6 md:py-8"
        ...
        >
          {duplicatedMembers.map((member, index) => (
            <motion.div
              ...
              transition={{
                duration: 0.5,
                delay: (index % teamMembers.length) * 0.1,
              }}
            ...
            >
              <motion.div
                className="relative w-[240px] sm:w-[280px] md:w-[340px] lg:w-[380px] h-[360px] sm:h-[400px] md:h-[480px] lg:h-[520px] rounded-2xl sm:rounded-3xl overflow-hidden cursor-pointer perspective-1000"
                animate={{
